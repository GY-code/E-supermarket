        ...
        <div class="w-box">
          ...
          <div class="right-box">
            <div class="nav-list">
              ...
              <router-link to="/goods"><a style="font-size: 14px; color:white" @click="changePage(2)">全部商品</a></router-link>
...
<!--                          </span>-->
                          <span class="avatar" :style="{backgroundImage:'url(static/images/user-avatar.png)'}">
                          </span>
                        </div>
                        <p class="name" style="color: black">{{userInfo.info.username}}</p>
                      </li>
                      <li>
  ...
  export default{
    ...
    methods: {
      ...
      _getCartList () {
        ...
        // getUsableCouponList({userId: Number(getStore('userId'))}).then(res => {
        //   if (res.success === true) {
        //     setStore('usableCoupons', res.result)
        //   }
        // }).then(this.INIT_BUYCART)
      },
      // 删除商品
...
<style lang="scss" rel="stylesheet/scss" scoped>
  ...
  .w-box {
    ...
    h1 {
      ...
      align-items: center;
      > a {
        background: url(/static/images/S_white.png) no-repeat 50%;
