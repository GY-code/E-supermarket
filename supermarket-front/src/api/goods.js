...
export const getCouponList = (params) => {
  return http.fetchPost('/coupon/getCouponList', params)
}

// 获取当前购物车可用的优惠券
export const getPerfectCouponList = (params) => {
  return http.fetchPost('/coupon/getPerfectCoupon', params)
}

// 获取秒杀活动结束时间
export const getSecKillInitTime = (params) => {
  return http.fetchPost('/goods/getSecKillInitTime', params)
}

// 获取优惠券积分值
export const getCouponPoint = (params) => {
  return http.fetchPost('/coupon/getPoint', params)
}

// 兑换优惠券
export const redemptCoupon = (params) => {
  return http.fetchPost('/coupon/addCoupon', params)
}

// 兑换优惠券
export const insertCouponToOrder = (params) => {
  return http.fetchPost('/coupon/insertCouponToOrder', params)
}

// 订单支付成果
export const payOrderSuc = (params) => {
  return http.fetchPost('/member/payOrderSuc', params)
}
