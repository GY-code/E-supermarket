...
<!--          <div class=img-box><img src="/static/images/user-avatar.png" alt=""></div>-->
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      _getBasicInfo () {
        console.log('hh' + this.userId.toString())
        let params = {
          params: {
            userId: this.userId
          }
        }
        http.fetchGet('/member/' + Number(this.userId), params).then(res => {
          console.log('bkkjs')
          this.balance = res.result.balance
          this.points = res.result.points
          this.memberLvl = res.result.vipLevel
        })
        // userInfo(params).then(res => {
        //   this.balance = res.result.balance
        //   this.points = res.result.points
        //   // this.totalConsumption = res.result.totalConsumption
        //   // this.memberLvl = res.result.vip_level
        // })
      },
      message (m) {
        this.$message(m)
