...
<style lang="scss" rel="stylesheet/scss" scoped>
  ...
  .main-btn {
    ...
    //}
    @include color(#e35c5c, #fff, #e76767);
    background-image: -webkit-linear-gradient(top, #e76767, #df5050);
    background-image: linear-gradient(180deg, #e76767, #df5050);
    @extend %style;
    &:hover {
      background-color: #d46c6c;
      background-image: -webkit-linear-gradient(top, #d48b6c, #c24747);
      background-image: linear-gradient(180deg, #d4886c, #c24747);
    }
  }
